                ...
                <View style={styles.filterContainer}>
                    <View style={styles.row}>
                        ...
                        >
                            ...
                            <Picker.Item style={styles.labelText} label="Follow" value={'Follow'} />
                            <Picker.Item style={styles.labelText} label="Intersted" value={'Intersted'} />
                            <Picker.Item style={styles.labelText} label="Place With Other" value={'Place_With_Other'} />
                        </Picker>
                    </View>
                            ...
                            paginatedData.map((item, index) => (
                                <View
                                    ...
                                    style={[
                                        ...
                                        {
                                            backgroundColor:
                                                item.ticketstatus === 'Follow' ? '#fff3b0' :
                                                    item.ticketstatus === 'Intersted' ? 'orange' :
                                                        item.ticketstatus === 'Place_With_order' ? '#ccd5ae' :
