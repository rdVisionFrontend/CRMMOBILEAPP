    ...
    const fetchStage1Data = async () => {
        try {
            const response = await axios.post(
                `http://54.172.58.86:8080/third_party_api/ticket/negotiationstagebased`,
                {
                                    ...
                                    <View style={{ flexDirection: 'column' }}>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: `90%`, gap: 5 }}>
                                            <Text
                                                ...
                                                item && item.ticketstatus === 'Sale' ? { backgroundColor: 'green', color: 'white' } : {}
                                                ]}
                                            >
                                                {item.ticketstatus}
                                            </Text>
