            ...
            <Tab.Navigator
                screenOptions={({ route }) => ({
                    tabBarIcon: ({ color, size }) => {
                        let iconUrl;
                        if (route.name === 'Login') {
                            iconUrl = 'https://cdn-icons-png.flaticon.com/128/1946/1946488.png'; // Login icon URL
                        } else if (route.name === 'Profile') {
                            iconUrl = 'https://cdn-icons-png.flaticon.com/128/1077/1077063.png'; // Profile icon URL
                        } else if (route.name === 'Ticket') {
                            iconUrl = 'https://cdn-icons-png.flaticon.com/128/389/389801.png'; // Ticket icon URL
                        } else if (route.name === 'Logout') {
                            iconUrl = 'https://cdn-icons-png.flaticon.com/128/9208/9208320.png'; // Logout icon URL (add your own if you need)
                        }
